...
from knowledge_base.embeddings_api import embed_texts, aembed_texts, embed_documents
...
class KBService(ABC):
    ...
    def __init__(self,
        ...
        self.kb_info = f"knowledge base about {knowledge_base_name}"
    ...
    def _docs_to_embeddings(self, docs: List[Document]) -> Dict:
        '''
        List[Document] to VectorStore.add_embeddings
        '''
