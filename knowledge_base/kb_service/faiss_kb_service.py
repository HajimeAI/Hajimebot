...
from knowledge_base.kb_service.base import KBService, SupportedVSType, EmbeddingsFunAdapter
from knowledge_base.kb_cache.faiss_cache import kb_faiss_pool, ThreadSafeFaiss
from knowledge_base.knowledge_file import KnowledgeFile
from knowledge_base.utils import get_kb_path, get_vs_path
...
if __name__ == '__main__':
    ...
    print(faissService.search_docs("how to start api service."))
