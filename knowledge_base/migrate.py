...
from db.repository.knowledge_file_repository import add_file_to_db # ensure Models are imported
from db.repository.knowledge_metadata_repository import add_summary_to_db
from db.base import Base, engine
from db.session import session_scope
from knowledge_base.knowledge_file import (
...
def import_from_db(
    ...
    try:
        ...
        print(f"Cannot read: {sqlite_path}, error: {e}")
        return False
    ...
    def files2vs(kb_name: str, kb_files: List[KnowledgeFile]):
        for success, result in files2docs_in_thread(kb_files,
            ...
            if success:
                ...
                print(f"{kb_name}/{filename} is added to vector store, including {len(docs)} docs.")
